function sample_dwi_reg_shrink
...
step_i = linspace(d1, d2, 10);
for aa = 1:length(step_i)
    D1 = (step_i(aa) - d2)*(dir_z*dir_z') + d2*eye(3);
    ...
    filename = fullfile(output_dir, sprintf('sim_dataset_shrink_%02d.csv', aa));
